...
helpInfo =
    ...
    , "Charisma -> Increases chance of getting out of trouble"
    , "Strength -> Increases damage of some weapons"
    , "Constitution -> Increases health"
    , "---------------------"
    , "CHARACTER stats:"
    , "HP -> If it reaches 0, you die"
    , "Sanity -> Affects chances and quality of special actions. Sanity decreases after each ENEMY kill"
    ...
    , "Special Actions:"
    , "Taunt -> Chance to make an enemy do half damage for a number of turns"
    , "Furious Attack -> Attacks an enemy with a chance of doing double damage"
    , "Stealth -> Chance to make an enemy do half damage for a number of turns"
